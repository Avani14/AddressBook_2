...
public class AddressBookService extends Contacts{
    ...
    public static void addContacts()
    {
            ...
            String book = sc.next();
            if(AddressBook.arrayOfAddressBook.contains(book))
            {
                ...
                System.out.println("Please enter the Address book first");
            }
    ...
    public static void edit_contact()
    {
        ...
        if(AddressBook.arrayOfAddressBook.contains(bookname))
        {
        ...
        for (Contacts c: arrayOfContacts) {
            ...
            System.out.println("No book of this name found...");
        }
